      ...
      case 'ArrowUp': {
        if (type === 'chat'
          ...
          if (SIZE - store.state.msgNumber !== 0) {
            ...
            const newMsg = localChatMessagesStorage[SIZE -
            store.state.msgNumber]
            changeValue(newMsg)
          }
          ...
          if (SIZE - store.state.cmdNumber !== 0) {
            ...
            const newCmd = localConsoleCommandsStorage[SIZE -
            store.state.cmdNumber]
            changeValue(newCmd)
          }
        } else if (type === 'player'
          ...
          if (SIZE - store.state.playerNumber !== 0) {
            ...
            const newPlayer = localPlayersStorage[SIZE -
            store.state.playerNumber]
