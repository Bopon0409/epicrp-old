...
export const ShopsAndParlors = observer(() => {
  ...
  const SHOP_NAME =
    businessType > 0 ? ShopName[businessType].toLowerCase() : null;
  ...
  return store.state.show ? (
    <div className="shops-wrapper">
      <div className="business-info">
        ...
        <span className="business-info__name">
          {businessType !== -1 ? ShopName[businessType] : "Error"}
        </span>
      </div>
      <div className="business-items">
        ...
        {section !== -1 ? (
          <div className="items-and-colors">
            <Items />
            <Colors />
          </div>
        ) : (
          <div className="welcome">
            ...
            <span>
              Для начала выбора одежды воспользууйтесь навигационным меню и
              выберите категорию одежды, которая Вас интересует.
            </span>
          </div>
        )}
      </div>
