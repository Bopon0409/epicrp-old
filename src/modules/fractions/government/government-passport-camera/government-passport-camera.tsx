...
export const GovernmentPassportCamera = observer(() => {
  ...
  return store.state.show ? (
    <div
      className="government-passport-camera-wrapper"
      onKeyUp={keyClick}
      tabIndex={0}
    >
      <div className="government-passport-camera">
        ...
        <div className="main-window">
          ...
          <div className="camera-line">
            <div className="lowwer-left line-block">
              {" "}
              <span>ISO 200 F3.5</span>
            </div>
            <div className="camera-line__buttons">
              {Buttons.map((button, id) => (
                <div
                  className={cn("btn_block", {
                    "btn_block--active": id === activeKey,
                  })}
                  key={id}
                >
