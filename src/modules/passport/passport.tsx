...
export const Passport = observer(() => {
  const {
    uuid, name, nationality, married, gender,
    id, date
  ...
  const ChooseGender = () => gender ? 'Мужской' : 'Женский'
  ...
  return store.state.active ? (
    <div className='window'>
      <div className='passport'>
        ...
        <div className='passport-text_2'>IDENTIFICATION CARD</div>
