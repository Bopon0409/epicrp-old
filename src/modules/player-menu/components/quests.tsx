...
export const Quests = observer(() => {
  ...
  const changePlayerActiveQuest = (id: number) => {
    ...
    playerActiveQuest === -1
      ? store.setActivePlayerQuest(id)
      : store.setActivePlayerQuest(-1);
  };
  const activeQuestFromList =
    activeQuest === -1 ? playerActiveQuest : activeQuest;
    ...
    <div className="quests-window">
      <div className="active-quest">
        {activeQuest >= 0 && quests.length && (
          <>
            ...
            <div className="active-quest__name">
              "{quests[activeQuest].name}"
            </div>
            <div className="active-quest__comment">
              {quests[activeQuest].questComment}
            </div>
            ...
            <div
              className="btn-quest-move"
              style={
                playerActiveQuest === activeQuest
                  ? QuestBtnActiveStyle
                  : QuestBtnDisableQuest
              }
      ...
      <div className="quests-list">
        ...
        {quests.map((quest, id) => (
          <div
            className={cn("quest", {
              "quest--active": activeQuestFromList === id,
            })}
            key={id}
