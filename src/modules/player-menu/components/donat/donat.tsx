        ...
        (<div className='donat-move_confirm'>
          ...
          <div>
            ...
            <div className="move_confirm-buttons">
              <div className='cancel' onClick={() => hideConfirmWindow()}>{donatStore.confirmWindow.buttons[0][0]}</div>
              <div className='accept' onClick={() => makeConfirmMove()}>{donatStore.confirmWindow.buttons[1][0]}</div>
            </div>
          </div>
        </div>) : null
      }
