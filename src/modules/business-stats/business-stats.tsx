...
export const BusinessStats = observer(() => {
  ...
  useEffect(() => {
    ...
    const {
      setActive, setStats, setWarehouse,
    ...
    return () => {
      ...
      em.removeHandler('business-stats.products-irl-items',
        setProductsIrlItems
      )
      em.removeHandler('business-stats.staff', setStaff)

      em.removeHandler('business-stats.staff-hoof', staffHoof)
      em.removeHandler('business-stats.warehouse-clearData',
        warehouseClearData
      )
      em.removeHandler('business-stats.stats-setBusinessStatus',
        setBusinessStatus
      )
      em.removeHandler('business-stats.change-player-money', changePlayerMoney)
      em.removeHandler('business-stats.change-business-money',
        changeBusinessMoney
      )
    }
  }, [])
